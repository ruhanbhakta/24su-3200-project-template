...
@advisor.route('/acceptedapps', methods=['GET'])
def accepted_apps():
    try:
...
@advisor.route('/totalapps', methods=['GET'])
def total_apps():
    try:
        # Get a database connection
        connection = db.connect()
...
@advisor.route('/companysizes', methods=['GET'])
...
@advisor.route('/alumnicount', methods=['GET'])
...
@advisor.route('/coopcount', methods=['GET'])
